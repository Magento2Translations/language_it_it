...
# Version & progress
This translation is generated from the branch [2.2.3](https://crowdin.com/project/magento-2/it#/2.2.3) at Crowdin and based on the Magento 2.2.3 sourcefiles.
There have been  8049 strings translated of the 9742 strings in the Magento source.
...
composer require magento2translations/language_it_it:2.2.3-dev
php bin/magento cache:clean
```
## Manually
To install this language package manually you need access to your server file system.
* Download the zip file [here](https://github.com/Magento2Translations/language_it_it/archive/2.2.3.zip).
